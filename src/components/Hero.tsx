    ...
    <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-gradient-to-br from-purple-50 via-white to-pink-50">
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
        ...
        <div className="text-center lg:text-left space-y-8 sm:space-y-10 animate-fade-in-ultra-slow order-2 lg:order-1">
          <div>
            <p className="text-lg sm:text-xl text-purple-600 font-semibold mb-3 animate-fade-in-ultra-slow transform hover:scale-105 transition-all duration-700 animate-bounce-ultra-gentle" style={{ animationDelay: '0.5s' }}>
              Hello, I am Rani Ghazi
            </p>
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-gray-900 leading-tight animate-fade-in-ultra-slow hover:text-purple-700 transition-all duration-700 transform hover:scale-105" style={{ animationDelay: '0.8s' }}>
              Software Engineer
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-purple-600 mt-3 animate-fade-in-ultra-slow hover:text-purple-800 transition-all duration-700 transform hover:scale-105" style={{ animationDelay: '1.2s' }}>
              UX Designer
            </h2>
          </div>
          
          <p className="text-lg sm:text-xl text-gray-600 max-w-2xl leading-relaxed animate-fade-in-ultra-slow mx-auto lg:mx-0 transform hover:text-gray-800 transition-all duration-500 hover:scale-105" style={{ animationDelay: '1.6s' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-6 animate-fade-in-ultra-slow justify-center lg:justify-start" style={{ animationDelay: '2s' }}>
            ...
            <Button 
              ...
              variant="outline" 
              className="border-2 border-purple-600 text-purple-600 hover:bg-purple-50 hover:border-purple-700 hover:text-purple-700 px-8 sm:px-10 py-4 rounded-full font-semibold transition-all duration-700 hover:scale-110 hover:shadow-2xl transform w-full sm:w-auto shadow-lg hover:-rotate-2"
            >
              View Portfolio
            </Button>
          </div>
        ...
        {/* Enhanced Profile Image with optimized loading and animations */}
        <div className="flex justify-center animate-scale-in-ultra-slow order-1 lg:order-2" style={{ animationDelay: '1s' }}>
          <div className="relative group">
            ...
            <div className="absolute -top-2 -left-2 w-8 h-8 bg-gradient-to-br from-cyan-300 to-blue-400 rounded-full animate-float-ultra-slow opacity-70 hover:opacity-100 transition-opacity duration-500"></div>
            <div className="absolute -bottom-2 -right-2 w-6 h-6 bg-gradient-to-br from-rose-300 to-pink-400 rounded-full animate-bounce-ultra-gentle animation-delay-1000 opacity-70 hover:opacity-100 transition-opacity duration-500"></div>
          </div>
        </div>
      </div>

      {/* Enhanced scroll indicator with better mobile centering and animations */}
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce-ultra-gentle cursor-pointer hover:scale-125 transition-all duration-700 group z-20" onClick={scrollToPortfolio}>
        <div className="bg-white rounded-full p-3 shadow-xl group-hover:shadow-2xl transition-all duration-500 border border-purple-100 flex items-center justify-center group-hover:bg-purple-50 animate-glow-ultra-slow">
          <ArrowDown className="w-6 h-6 text-purple-600 group-hover:text-purple-800 transition-all duration-500 group-hover:scale-110 animate-bounce-ultra-gentle" />
        </div>
      </div>
    </section>
  );
